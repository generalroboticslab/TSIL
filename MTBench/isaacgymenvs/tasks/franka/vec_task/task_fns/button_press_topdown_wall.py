...
def compute_observations(env, env_ids):
    ...
    wall_pos = self._root_state[self.franka_actor_idx[env_ids]+2,:3]
...
def reset_env(env,tid, env_ids, random_reset_space):
    ...
    self._root_state[wall_multi_env_ids_wall_int32,0] = buttonbox_x - .15
    self._root_state[wall_multi_env_ids_wall_int32,1] = buttonbox_y - .05
