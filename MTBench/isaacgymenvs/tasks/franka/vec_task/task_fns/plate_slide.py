...
def compute_reward(
    ...
    rewards = 8 * in_place_and_object_grasped
...
def reset_env(env, tid, env_ids, random_reset_space):
    ...
    self._root_state[puck_goal_multi_env_ids_int32,:3] = self.last_rand_vecs[env_ids,3:].clone() + to_torch([0,0,-.015],device=self.device)
