...
from envs.isaacgymenvs.tasks.vec_task import VecTask
...
from envs.isaacgymenvs.utils.task_utils import is_in_cup, project_point_on_segment, is_under_valid_vel, is_under_valid_contact, mix_clone, mix_norm, ema_filter
from envs.isaacgymenvs.utils.obj_utils import create_hollow_cylinder, create_hollow_cylinder_mesh

from copy import deepcopy
from core.common.tf_utils import tf_inverse as tf_inverse_np, tf_combine as tf_combine_np
...
# Keep this eager-mode reward path unless the TorchScript memory issue is revisited.
